...
The two functions of miRge2.0are:\n\
   ...
   predict       Detect novel miRNAs from miRNA sequencing data\n\
	...
	parser_1.add_argument('-pb', required=False, dest='bowtieBinary', metavar='<dir required>', help="the path to the system's bowtie binary")
	...
	parser_2.add_argument('-pb', required=True, dest='bowtieBinary', metavar=None, help="the path to the system's bowtie binary")
